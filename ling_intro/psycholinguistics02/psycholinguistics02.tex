...
\begin{document}
  ...
  \section{Speech Production}
      ...
      \begin{frame}[t]{\subonetwo}
        ...
        \only<1>{
          \begin{block}{This is a serial model}
            \begin{itemize}
              \item \alert{Serial model}: \input{\defs/part4/def_serial_model.tex}
              \item \alert{Parallel mode}: \input{\defs/part4/def_parallel_model.tex}
            \end{itemize}
          \end{block}
        }
        \only<2>{
    ...
    \subsection{\subonethree}
      ...
      % Repetitions do increase access speed as well
    ...
    \subsection{\subonefour}
      ...
      \begin{frame}{\subonefour}
        \begin{block}{Are rules real?}
          ...
          \begin{itemize}
            \item \sent{Freudian slip} $\rightarrow$ \uttr{Freulian [ʃɹ]ip}
          \end{itemize}
      ...
      \begin{frame}[t]{\subonefour}
        ...
        \only<-2>{
          \begin{block}{Which is more likely to yield a spoonerism? \parencite{motley_covert_1982}}
            \uncover<2->{
              (a) because \uttr{fart smell} is more taboo
              \begin{itemize}
        ...
        \only<5->{
          \begin{block}{Does this support Levelt's model?}
            Yes: Parallel models support feed back
          \end{block}
        }
      \end{frame}
