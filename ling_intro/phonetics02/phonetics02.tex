  ...
  \section{Anatomy and articulation}
        ...
        \begin{columns}
          \column{0.45\textwidth}
            \begin{minipage}[c][0.6\textheight]{\linewidth}
              \only<1-2>{
                \begin{definition}
                  \input{\defs/part1/def_place_of_articulation.tex} in the vocal tract\uncover<2>{\emph{, which means we're not talking about vowels}}
                \end{definition}
              }
              \only<3>{
    ...
    \subsection{\subtwofour}
      \begin{frame}[t]{\subtwofour}
        \only<1-2>{
          \begin{definition}
            \input{\defs/part1/def_manner_of_articulation.tex} in the vocal tract\uncover<2>{, \emph{which means we're still talking about consonants}}
          \end{definition}
        }
        \only<3->{
