    ...
    \subsection{\suboneone}
      \begin{frame}{\suboneone}
        ...
        \begin{definition}<3>
          ...
          \input{../definitions/part1/def_articulatory_phonetics.tex} (i.e., \alert{articulation})
        \end{definition}
      \end{frame}
      ...
      \begin{frame}{\subonetwo}
        \begin{block}{}
          ...
          \begin{itemize}
            ...
            \item \input{../definitions/part1/def_place_of_articulation.tex} (i.e., the \alert{place of articulation}), and
            \item \input{../definitions/part1/def_manner_of_articulation} (i.e., the \alert{manner of articulation})
          \end{itemize}
        \end{block}
        \begin{alertblock}<2>{}
  ...
  \section{Anatomy and articulation}
              ...
              \begin{minipage}[c][0.6\textheight]{\linewidth}
                \begin{block}{Broad components}
                  \begin{itemize}
                    ...
                    \begin{itemize}
                      \item \input{../definitions/part1/def_subglottal_system.tex}
                    \end{itemize}
                    \item \alert{Larynx}
                    \begin{itemize}
                      \item \input{../definitions/part1/def_larynx.tex}
                    \end{itemize}
                    }
                    \only<2>{
                    \item \alert{Vocal tract}
                    \begin{itemize}
                      \item \input{../definitions/part1/def_vocal_tract.tex}
                    \end{itemize}
                    }
                  \end{itemize}
                \end{block}
          ...
          \column{0.45\textwidth}
            \only<1>{
              \begin{minipage}[c][0.6\textheight]{\linewidth}
                \begin{block}{}
                  \begin{itemize}
                    \item \alert{Voiced} sounds: \input{../definitions/part1/def_voiced_sounds.tex}
                    \item \alert{Voiceless} sounds: \input{../definitions/part1/def_voiceless_sounds.tex}
                  \end{itemize}
                \end{block}
              \end{minipage}
            }
        ...
        \begin{columns}
          \column{0.45\textwidth}
            \begin{minipage}[c][0.6\textheight]{\linewidth}
              \only<1-2>{
                \begin{definition}
                  \input{../definitions/part1/def_place_of_articulation.tex} in the vocal tract\uncover<2>{\emph{, which means we're not talking about vowels}}
                \end{definition}
              }
              \only<3>{
    ...
    \subsection{\subtwofour}
      \begin{frame}[t]{\subtwofour}
        \only<1-2>{
          \begin{definition}
            \input{../definitions/part1/def_manner_of_articulation.tex} in the vocal tract\uncover<2>{, \emph{which means we're still talking about consonants}}
          \end{definition}
        }
        \only<3->{
