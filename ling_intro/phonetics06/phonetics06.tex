      ...
      \begin{frame}{\suboneone}
        \only<1-3>{
          ...
          \begin{definition}<2-3>
            ...
            \input{../definitions/part1/def_acoustic_phonetics.tex}
          \end{definition}
          \begin{alertblock}<3>{}
      ...
      \begin{frame}[t]{\subtwoone}
        \only<1-2>{
          \begin{alertblock}{A sound wave}
            \input{../definitions/part1/def_sound_wave.tex}
          \end{alertblock}
        }
        \only<2>{
          \begin{columns}
            ...
            \column{0.5\textwidth}
              \only<3>{
                \begin{alertblock}{A waveform}
                  ...
                  \input{../definitions/part1/def_waveform.tex}
                \end{alertblock}
              }
              \only<4-6>{
                \begin{block}{Two aspects of a sound wave}
                  \begin{itemize}
                    \item \alert{Frequency}: \input{../definitions/part1/def_frequency.tex}
                    \item \alert{Amplitude}: \input{../definitions/part1/def_amplitude.tex}
                  \end{itemize}
                \end{block}
              }
            \column{0.5\textwidth}
      ...
      \begin{frame}{\subtwothree}
        \only<1>{
          ...
          \begin{alertblock}{Formant}
            ...
            \input{../definitions/part1/def_formant.tex}
            There are two important formants for vowels:
            \begin{itemize}
              \item \alert{Formant 1 (F1)}: \input{../definitions/part1/def_F1.tex}
              \item \alert{Formant 2 (F2)}: \input{../definitions/part1/def_F2.tex}
            \end{itemize}
          \end{alertblock}
        }
        \only<2>{
        ...
        \only<3->{
          \begin{alertblock}{Spectrograms}
            ...
            \input{../definitions/part1/def_spectrogram.tex}
          \end{alertblock}
      ...
      \begin{frame}{\subtwofour}
        \only<1-2>{
          \begin{block}{Stops}
            ...
            \begin{itemize}
              ...
              \item<2> Voiced sounds have a \alert{voice bar} at the bottom
            \end{itemize}
          \end{block}
        ...
        \only<3>{
          \begin{alertblock}{Aspiration}
            ...
            \input{../definitions/part1/def_aspiration.tex}, notated with [ʰ]
            \begin{itemize}
        ...
        \only<5-6>{
          \begin{block}{Nasals}
            ...
            \begin{itemize}
              ...
              \item<6> Liquids and glides also have formants
            \end{itemize}
          \end{block}
