...
\begin{document}
  ...
  \begin{questions}
      ...
      \instr{Give the natural class that the sounds in the set all belong to. (1 point each)}

        \parbox[t]{0.45\linewidth}{
          \question[1] [ʒ s θ]: \hrulefill
          \question[1] [s h ]: \hrulefill
          \question[1] [w n]: \hrulefill
          \question[1] [j dʒ z]: \hrulefill
      ...
      \instr{Each of the following is representative of a type of phonological rule. Give the type. (1 point each)}
        ...
        \parbox[t]{0.45\linewidth}{
          ...
          \question[1] \phon{/ˈæm.fə.θi.ɾɹ̩/}{[ˈæm.pə.θi.ɾɹ̩]}: \hrulefill
    ...
    \section{Morphology}
      ...
      \instr{For each word, identify which morphemes are present. For those with multiple morphemes, indicate the type for each affix (i.e., prefix or suffix) and whether it's derivational or inflectional. (3 points each)}
      ...
      \instr{Each of the following is representative of a type of morphological process. Give the type. (1 point each)}
      ...
      \instr{Perform a morphological analysis by using the following data from the language Luiseño to answer the questions below. (1 point each)}
        ...
        \question How would you say the following in Isleta?
          \begin{parts}
