    ...
    \subsection{\suboneone}
      \begin{frame}{\suboneone}
        \only<-3>{
          ...
          \end{block}
          \begin{alertblock}<2->{This is merely a convention}
    ...
    \subsection{\subonetwo}
      \begin{frame}{\subonetwo}
        \begin{alertblock}{Analytic languages}
          \input{\defs/part2/def_analytic_language.tex}
        \end{alertblock}
        \begin{example}
          Mandarin:
          \begin{itemize}
    ...
    \subsection{\subonethree}
      \begin{frame}{\subonethree}
        \begin{alertblock}{Agglutinating languages}
          \input{\defs/part2/def_agglutinating_language.tex}
        \end{alertblock}
        \begin{example}
          Swahili:
          \begin{itemize}
    ...
    \subsection{\subonefour}
      \begin{frame}{\subonefour}
        \begin{alertblock}{Fusional languages}
          \input{\defs/part2/def_fusional_language.tex}
        \end{alertblock}
        \begin{example}
          Spanish:
          \begin{itemize}
    ...
    \subsection{\subonefive}
      \begin{frame}{\subonefive}
        \begin{alertblock}{Polysynthetic languages}
          \input{\defs/part2/def_polysynthetic_language.tex}
        \end{alertblock}
        \begin{example}
          Sora:
          \begin{itemize}
