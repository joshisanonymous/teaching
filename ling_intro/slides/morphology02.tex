...
\begin{document}
  ...
  \section{Morphological processes}
    ...
    \subsection{\subonetwo}
      \begin{frame}[t]{\subonetwo}
        ...
        \only<1>{
          \begin{block}{}
            Affixation is almost all we've seen so far
          \end{block}
        }
        \only<2->{
          \begin{alertblock}{Affixation}
            \input{\defs/part2/def_affixation.tex}
          \end{alertblock}
        }
        \only<3-4>{
    ...
    \begin{frame}[t]{\subonethree}
      \begin{example}
        \begin{itemize}
          ...
          \item \lexi{black} + \lexi{bird} $=$ \only<-2>{\lexi{blackbird}}\only<3->{\orth{blackbird}}
          \item \lexi{self} + \lexi{evident} $=$ \only<-2>{\lexi{self-evident}}\only<3->{\orth{self-evident}}
        \end{itemize}
      \end{example}
      \only<1>{
        \begin{block}{}
          We've also seen compounding
        \end{block}
      }
      \only<2>{
        \begin{alertblock}{Compound}
          \input{\defs/part2/def_compound.tex}
        \end{alertblock}
        \begin{alertblock}{Compounding}
          \input{\defs/part2/def_compounding.tex}
        \end{alertblock}
      }
      \only<3>{
        ...
        \begin{block}{Compounding is highly productive in English}
          \begin{itemize}
            \item \begin{tabular}{l l l l}
                    ...
                    \uncover<6->{noun} & \uncover<6->{noun} & \uncover<6->{noun} & \uncover<6->{noun}
                  \end{tabular}
          \end{itemize}
        \end{block}
      }
      ...
      \only<-2>{
        ...
        \only<1>{
          \begin{alertblock}{Reduplication}
            \input{\defs/part2/def_reduplication.tex}
          \end{alertblock}
          \begin{alertblock}{Reduplicant}
            \input{\defs/part2/def_reduplicant.tex}
          \end{alertblock}
        }
        \only<2->{
          \begin{block}{Only marginal examples in English}
      ...
      \only<3-6>{
        ...
        \only<4>{
          \begin{alertblock}{Total reduplication}
            \input{\defs/part2/def_total_reduplication.tex}
          \end{alertblock}
          \begin{alertblock}{Partial reduplication}
            \input{\defs/part2/def_partial_reduplication.tex}
          \end{alertblock}
        }
        \only<5->{
    ...
    \begin{frame}[t]{\subonefive}
      ...
      \only<1>{
        \begin{alertblock}{Apophony}
          \input{\defs/part2/def_apophony.tex}
        \end{alertblock}
      }
      \only<2-3>{
        \begin{block}{Which are derivations and which inflections?}
          \uncover<3->{
            \begin{itemize}
              \item Inflections: [ˈɡis], [ˈfit], and [ˈdɹæŋk]/[ˈdɹʌŋk]
  ...
  \subsection{\subonesix}
    \begin{frame}[t]{\subonesix}
      \begin{example}
        \begin{itemize}
          \item {[}ˈɪz] ̩$\rightarrow$ [ˈwʌz]
          \item {[}ˈɡoʊ] $\rightarrow$ [ˈwɛnt]
          \item {[}ˈɡʊd] $\rightarrow$ [ˈbɛ.ɾɹ̩]
          \item {[}ˈbæd] $\rightarrow$ [ˈwʌɹs]
        \end{itemize}
      \end{example}
      \only<1>{
        \begin{block}{}
      ...
      \only<2>{
        \begin{alertblock}{Suppletion}
          \input{\defs/part2/def_suppletion.tex}
        \end{alertblock}
      }
      \only<3-4>{
        \begin{block}{Which are derivations and which inflections?}
          \uncover<4->{
            \begin{itemize}
              \item Inflections: [ˈwʌz], [ˈwɛnt], [ˈbɛ.ɾɹ̩], and [ˈwʌɹs]
