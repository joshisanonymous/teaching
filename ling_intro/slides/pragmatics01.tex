    ...
    \subsection{\suboneone}
      \begin{frame}{\suboneone}
        ...
        \begin{alertblock}<2->{Pragmatics}
          \input{\defs/part3/def_pragmatics.tex}
        \end{alertblock}
      \end{frame}
      ...
      \begin{frame}[t]{\subonetwo}
        ...
        \only<1>{
          \begin{alertblock}{Utterance}
            \input{\defs/part3/def_utterance.tex}
          \end{alertblock}
          \begin{alertblock}{Sentence}
            \input{\defs/part3/def_sentence.tex}
          \end{alertblock}
        }
        \only<2>{
      ...
      \begin{frame}[t]{\subonetwo}
        ...
        \only<1-2>{
          ...
          \begin{alertblock}<2->{Deictic word}
            \input{\defs/part3/def_deictic_word.tex}
          \end{alertblock}
        }
        \only<3->{
    ...
    \subsection{\subonethree}
      ...
      \begin{frame}{\subonethree}
        \begin{alertblock}{Linguistic context}
          \input{\defs/part3/def_linguistic_context.tex}
        \end{alertblock}
      ...
      \begin{frame}{\subonethree}
        \begin{alertblock}{Situational context}
          \input{\defs/part3/def_situational_context.tex}
        \end{alertblock}
      ...
      \begin{frame}{\subonethree}
        \begin{alertblock}{Social context}
          \input{\defs/part3/def_social_context.tex}
        \end{alertblock}
    ...
    \subsection{\subonefour}
      \begin{frame}{\subonefour}
        \begin{alertblock}{Felicitous utterances}
          \input{\defs/part3/def_felicitous_utterance.tex}
        \end{alertblock}
