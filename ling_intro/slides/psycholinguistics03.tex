  ...
  \section{Speech Perception}
    \subsection{\suboneone}
      \begin{frame}{\suboneone}
        ...
        \begin{alertblock}{Lack of invariance problem}
          \input{\defs/part4/def_lack_of_invariance_problem.tex}
          \begin{itemize}
    ...
    \subsection{\subonetwo}
      \begin{frame}[t]{\subonetwo}
        \begin{definition}
          \input{\defs/part4/def_normalization.tex}
        \end{definition}
        \only<1>{
          \begin{example}
    ...
    \subsection{\subonethree}
      \begin{frame}[t]{\subonethree}
        \begin{definition}
          \input{\defs/part4/def_categorical_perception.tex}
        \end{definition}
        \only<1>{
          \begin{center}
        ...
        \only<2>{
          \begin{block}{What about in language?}
            \alert{Voice onset time} (VOT): \input{\defs/part4/def_voice_onset_time.tex}
            \begin{itemize}
    ...
    \subsection{\subonefour}
      \begin{frame}{\subonefour}
        ...
        \begin{alertblock}<2->{Coarticulation}
          \input{\defs/part4/def_coarticulation.tex}
        \end{alertblock}
    ...
    \subsection{\subonesix}
      \begin{frame}{\subonesix}
        ...
        \end{example}
        \begin{definition}<2->
          \input{\defs/part4/def_mcgurk_effect.tex} \parencite{mcgurk_hearing_1976}
        \end{definition}
        \begin{block}<2->{}
          \begin{itemize}
    ...
    \subsection{\suboneeight}
      \begin{frame}{\suboneeight}
        \begin{definition}
          \input{\defs/part4/def_phonemic_restoration.tex} \parencite{warren_perceptual_1970}
        \end{definition}
        \begin{example}
