  ...
  \section{Variation at Different Levels}
    ...
    \subsection{\subonethree}
      \begin{frame}[t]{\subonethree}
        \begin{definition}
          \input{\defs/part2/def_phonology.tex}
        \end{definition}
        \only<-2>{
    ...
    \subsection{\subonesix}
      \begin{frame}[t]{\subonesix}
        \begin{block}{}
          \begin{itemize}
            \item Semantics: \input{\defs/part3/def_semantics.tex}
            \item Lexical expression: \input{\defs/part3/def_lexical_expression.tex}
          \end{itemize}
        \end{block}
        \only<-2>{
          \begin{columns}
