    ...
    \subsection{\suboneone}
      ...
      \begin{frame}{\suboneone}
        \begin{alertblock}{Cooperative principle \parencite{grice_logic_1989}}
          \input{\defs/part3/def_cooperative_principle.tex}
        \end{alertblock}
    ...
    \subsection{\subonetwo}
      ...
      \begin{frame}[t]{\subonetwo}
        \begin{alertblock}{The maxim of relevance}
          \input{\defs/part3/def_maxim_of_relevance.tex}
        \end{alertblock}
        \only<2>{
        ...
        \only<3-5>{
          ...
          \only<5->{
            \begin{alertblock}{Implicature}
              \input{\defs/part3/def_implicature.tex}
            \end{alertblock}
          }
        }
        \only<6>{
      ...
      \begin{frame}[t]{\subonetwo}
        \begin{alertblock}{The maxim of quality}
          \input{\defs/part3/def_maxim_of_quality.tex}
        \end{alertblock}
      ...
      \begin{frame}[t]{\subonetwo}
        \begin{alertblock}{The maxim of quantity}
          \input{\defs/part3/def_maxim_of_quantity.tex}
        \end{alertblock}
        \only<2>{
          \begin{example}
      ...
      \begin{frame}[t]{\subonetwo}
        \begin{alertblock}{The maxim of manner}
          \input{\defs/part3/def_maxim_of_manner.tex}
        \end{alertblock}
        \only<2>{
          \begin{alertblock}{}
    ...
    \subsection{\subonethree}
      \begin{frame}[t]{\subonethree}
        \begin{alertblock}{Flouting a maxim}
          \input{\defs/part3/def_flouting_a_maxim.tex}
        \end{alertblock}
        \only<2>{
          \begin{example}
