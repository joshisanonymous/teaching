  ...
  \section{Language Varieties}
    \subsection{\subtwoone}
      \begin{frame}{\subtwoone}
        \begin{alertblock}{Variety}
          \input{\defs/part4/def_variety.tex}
        \end{alertblock}
        ...
        \begin{block}{Dimensions of variation}
          \begin{itemize}
            ...
            \begin{itemize}
              ...
              \item \alert{Accent}: \input{\defs/part4/def_accent.tex}
            \end{itemize}
          \end{itemize}
        \end{block}
      \end{frame}
    ...
    \subsection{\subtwotwo}
      \begin{frame}[t]{\subtwotwo}
        \begin{definition}
          \input{\defs/part4/def_dialect.tex}
        \end{definition}
        \only<1>{
          \begin{columns}
              ...
              \begin{minipage}[t][0.6\textheight]{\linewidth}
                \only<2>{
                  \begin{alertblock}{Speech community}
                    \input{\defs/part4/def_speech_community.tex} \parencite{labov_social_2006}
                  \end{alertblock}
                }
                \only<3>{
              ...
              \begin{minipage}[t][0.6\textheight]{\linewidth}
                \begin{block}{Mutual intelligibility?}
                  ...
                  \only<5->{
                    ...
                    \begin{itemize}
                      \item \input{\defs/part4/def_dialect_continuum.tex}
                    \end{itemize}
                  }
                \end{block}
              \end{minipage}
    ...
    \subsection{\subtwofour}
      ...
      \begin{frame}[t]{\subtwofour}
        \begin{alertblock}{Style}
          \input{\defs/part4/def_style.tex}
        \end{alertblock}
        \only<2-3>{
          \begin{alertblock}{Idiolect}
            \input{\defs/part4/def_idiolect.tex}
          \end{alertblock}
          ...
          \begin{columns}
            \column{0.5\linewidth}
              \begin{alertblock}{Style shifting}
                \input{\defs/part4/def_style_shifting.tex}
                \begin{itemize}
    ...
    \subsection{\subtwofive}
      \begin{frame}{\subtwofive}
        \begin{block}{Lexical variation}
          \begin{itemize}
            \item \alert{Jargon}: \input{\defs/part4/def_jargon.tex}
            \item \alert{Slang}: \input{\defs/part4/def_slang.tex}
          \end{itemize}
        \end{block}
    ...
    \subsection{\subtwosix}
      \begin{frame}{\subtwosix}
        \begin{alertblock}{Standard variety}
          \input{\defs/part4/def_standard_variety.tex}
          \begin{itemize}
      ...
      \begin{frame}[t]{\subtwosix}
        \begin{alertblock}{Hypercorrection}
          \input{\defs/part4/def_hypercorrection.tex}
        \end{alertblock}
        \only<-2>{
          \begin{example}
            \begin{enumerate}
      ...
      \begin{frame}{\subtwosix}
        \begin{block}{Why do non-standard varieties persist?}
          \uncover<2->{
            \alert{Covert prestige} \parencite{labov_social_2006}: \input{\defs/part4/def_covert_prestige.tex}
          }
        \end{block}
      \end{frame}
