      ...
      \begin{frame}[t]{\subonetwo}
        ...
        \only<1>{
          \begin{alertblock}{Linguistic variable}
            \input{\defs/part4/def_linguistic_variable.tex}
            \begin{itemize}
            ...
            \begin{minipage}[t][0.6\textheight]{\linewidth}
              \begin{block}{Some features}
                ...
                \begin{itemize}
                  ...
                  \item \alert{Chain shift}: \input{\defs/part4/def_chain_shift.tex}
                \end{itemize}
                }
                \only<2>{
      ...
      \begin{frame}[t]{\subonefive}
        ...
        \only<1>{
          \begin{block}{The \textsc{cot-caught} merger}
            ...
            \begin{itemize}
              \item \alert{Merger}: \input{\defs/part4/def_merger.tex}
            \end{itemize}
          \end{block}
        }
        \only<2>{
