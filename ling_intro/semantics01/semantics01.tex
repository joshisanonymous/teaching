  ...
  \section{Semantics Basics}
    \subsection{\suboneone}
      \begin{frame}{\suboneone}
        \begin{definition}
          \input{\defs/part3/def_semantics.tex}
        \end{definition}
        \begin{example}<2->
      ...
      \begin{frame}{\suboneone}
        ...
        \begin{alertblock}{Lexical semantics}
          \input{\defs/part3/def_lexical_semantics.tex}
        \end{alertblock}
    ...
    \subsection{\subonetwo}
      \begin{frame}[t]{\subonetwo}
        \begin{block}{Two aspects of meaning}
          \begin{itemize}
            \item \alert{Sense}: \input{\defs/part3/def_sense.tex}
            \item \alert{Reference}: \input{\defs/part3/def_reference.tex}
          \end{itemize}
        \end{block}
        \only<2>{
          \begin{example}
        ...
        \only<3-4>{
          \begin{example}
            \parbox{0.48\linewidth}{
              ...
              \begin{itemize}
                \item<4-> \alert{Referent}: \input{\defs/part3/def_referent.tex}
              \end{itemize}
            }
            \parbox{0.48\linewidth}{
      ...
      \begin{frame}[t]{\subtwoone}
        ...
        \begin{example}
          \parbox{0.48\linewidth}{
            Sense of \lexi{bird}:
            \begin{itemize}
              \item<2-> \alert{Prototype}: \input{\defs/part3/def_prototype.tex}
            \end{itemize}
          }
          \parbox{0.48\linewidth}{
            \only<-2>{
      ...
      \begin{frame}[t]{\subtwotwo}
        ...
        \begin{columns}
          ...
          \column{0.48\linewidth}
            ...
            \only<2>{
              \includegraphics[scale=0.1]{large.jpg}
            }
        \end{columns}
      \end{frame}
    ...
    \subsection{\subtwothree}
      \begin{frame}{\subtwothree}
        ...
        \begin{alertblock}<2->{Sense relation}
          \input{\defs/part3/def_sense_relation.tex}
        \end{alertblock}
      ...
      \begin{frame}[t]{\subtwothree}
        \begin{alertblock}{Hyponymy}
          \input{\defs/part3/def_hyponymy.tex}
          \only<1>{
            \begin{itemize}
              \item \alert{Hyponym}: \input{\defs/part3/def_hyponym.tex}
              \item \alert{Hypernym}: \input{\defs/part3/def_hypernym.tex}
            \end{itemize}
          }
        \end{alertblock}
        \begin{columns}
            ...
            \begin{minipage}[c][0.6\textheight]{\linewidth}
              \begin{example}<2->
                ...
                \only<4->{
                  ...
                  \begin{itemize}
                    \item \input{\defs/part3/def_sister_terms.tex}
                  \end{itemize}
                }
              \end{example}
            \end{minipage}
      ...
      \begin{frame}[t]{\subtwothree}
        \begin{alertblock}{Synonymy}
          \input{\defs/part3/def_synonymy.tex}
        \end{alertblock}
        \begin{example}<2->
      ...
      \begin{frame}[t]{\subtwothree}
        \begin{alertblock}{Antonymy}
          \input{\defs/part3/def_antonymy.tex}
        \end{alertblock}
      ...
      \begin{frame}[t]{\subtwothree}
        \begin{alertblock}{Complementary antonyms}
          \input{\defs/part3/def_complementary_antonyms.tex}
        \end{alertblock}
        \begin{columns}
          \column{0.48\linewidth}
            \begin{example}
      ...
      \begin{frame}[t]{\subtwothree}
        \begin{alertblock}{Gradable antonyms}
          \input{\defs/part3/def_gradable_antonyms.tex}
        \end{alertblock}
        \begin{example}
          \begin{itemize}
      ...
      \begin{frame}[t]{\subtwothree}
        \begin{alertblock}{Reverse antonyms}
          \input{\defs/part3/def_reverse_antonyms.tex}
        \end{alertblock}
        \begin{example}
          \begin{itemize}
      ...
      \begin{frame}[t]{\subtwothree}
        \begin{alertblock}{Converse antonyms}
          \input{\defs/part3/def_converse_antonyms.tex}
        \end{alertblock}
        \begin{example}
          \begin{itemize}
