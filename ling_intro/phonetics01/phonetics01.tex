  ...
  \section{What is phonetics?}
    \subsection{\suboneone}
      \begin{frame}{\suboneone}
        \only<1-3>{
          \begin{block}<1-3>{}
            \input{\defs/part1/def_phonetics.tex} (i.e., words, consonants, vowels, intonation, and stress)
          \end{block}
          \begin{block}<2-3>{}
            ...
            \begin{itemize}
              \item \alert<3>{Articulatory phonetics}
                \begin{itemize}
                  \item \input{\defs/part1/def_articulatory_phonetics.tex}
                \end{itemize}
              \item \alert<3>{Acoustic phonetics}
                \begin{itemize}
                  \item \input{\defs/part1/def_acoustic_phonetics.tex}
                \end{itemize}
              \item Auditory phonetics
                \begin{itemize}
                  \item \input{\defs/part1/def_auditory_phonetics.tex}
                \end{itemize}
            \end{itemize}
          \end{block}
        }
      ...
      \begin{frame}[t]{\subtwothree}
        ...
        \only<2-3>{
          \begin{alertblock}{A segment}
            ...
            \begin{itemize}
              \item<3> \alert{Consonant}: \input{\defs/part1/def_consonant.tex}
              \item<3> \alert{Vowel}: \input{\defs/part1/def_vowel.tex}
            \end{itemize}
          \end{alertblock}
        }
        \only<4>{
          \begin{block}{The phthongs}
            \begin{itemize}
              \item A \alert{monophthong}: \input{\defs/part1/def_monophthong.tex}
              \item A \alert{diphthong}: \input{\defs/part1/def_diphthong.tex}
            \end{itemize}
          \end{block}
        }
        \only<5-6>{
            ...
            \column{0.5\textwidth}
              \only<5>{
                \begin{alertblock}{A syllable}
                  ...
                  \input{\defs/part1/def_syllable.tex}
                \end{alertblock}
              }
              \only<6>{
                \begin{alertblock}{A nucleus}
                  % Read in the definition of a nucleus
                  \input{\defs/part1/def_nucleus.tex}
                \end{alertblock}
              }
            \column{0.5\textwidth}
              \only<5>{
