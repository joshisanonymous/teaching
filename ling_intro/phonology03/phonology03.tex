        ...
        \only<7-10>{
          \begin{block}{Some new natural classes}
            \begin{itemize}
              ...
              \end{itemize}
              \item<8-> \alert{Labials}: \input{\defs/part2/def_labial.tex}
              \begin{itemize}
                \item Includes labiodentals and bilabials
              \end{itemize}
              \item<9-> \alert{Obstruents}: \input{\defs/part2/def_obstruent.tex}
              \begin{itemize}
                \item Includes stops, fricatives, and affricates
              \end{itemize}
              \item<10-> \alert{Sonorants}: \input{\defs/part2/def_sonorant.tex}
              \begin{itemize}
      ...
      \begin{frame}{\subonethree}
        ...
        \only<5-8>{
          ...
          \begin{example}<6->
            \begin{tabular}{c c}
              \lexi{sixth}                & \\
              \uncover<7->{/ˈsɪks\alert{θ}/}  & \uncover<9->{[ˈsɪks\alert{t}]}
            \end{tabular}
          \end{example}
        ...
        \only<16-19>{
          ...
          \begin{example}<17->
            \begin{tabular}{c c}
              ...
              \uncover<18->{[ˈask]}                                 & \uncover<18->{[ˈaks]}
            \end{tabular}
          \end{example}
