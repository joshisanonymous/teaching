            ...
            \begin{minipage}[c][0.6\textheight]{\linewidth}
              ...
              \only<3>{
                \begin{block}{Front rounded vowels}
                  ...
                  German has [y] and [ø]
                  \begin{itemize}
                    \item \orth{Güte} `kindness' [gytə] vs \orth{guter} `good' [gutə]
          ...
          \column{0.5\textwidth}
            ...
            \only<2->{
              \begin{adjustbox}{height=4.5cm}
                ...
                \input{../material_IPA_full_chart/material_IPA_full_chart_vowels.tex}
              \end{adjustbox}
            }
        \end{columns}
      \end{frame}
      ...
      \begin{frame}[t]{\subonethree}
        ...
        \only<2->{
          \begin{adjustbox}{width=\textwidth}
            ...
            \input{../material_IPA_full_chart/material_IPA_full_chart_consonants.tex}
          \end{adjustbox}
        }
        \only<2>{
          \begin{block}{}
