  ...
  \section{Introduction}
    ...
    \subsection{\subtwotwo}
      \begin{frame}{\subtwotwo}
        \begin{definition}<2->{}
          \begin{itemize}
            \item \alert{Language}: Human communication
            \item \alert{\emph{A} language}: A systematic set of words and rules that can be used for human communication \emph{and that is unique to each individual}
          \end{itemize}
        \end{definition}
        \begin{alertblock}<3->{}
