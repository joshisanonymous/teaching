    ...
    \subsection{\suboneone}
      \begin{frame}{\suboneone}
        ...
        \begin{block}{Would these be reasonable questions?}
          \begin{itemize}
            ...
            \item<2-> Does the monster really have fangs?
          \end{itemize}
          \uncover<3->{
            No. The utterances presume facts that aren't accurate, and these responses accept them
          }
        \end{block}
      \end{frame}
      ...
      \begin{frame}{\suboneone}
        \begin{alertblock}{Presupposition}
          \input{\defs/part3/def_presupposition.tex}
        \end{alertblock}
      ...
      \begin{frame}{\suboneone}
        ...
        \begin{alertblock}{Existence presupposition}
          \input{\defs/part3/def_existence_presupposition.tex}
        \end{alertblock}
      \end{frame}
    ...
    \subsection{\subonetwo}
      \begin{frame}{\subonetwo}
        ...
        \begin{block}{What are the truth values here?}
          \begin{enumerate}
            \item \existsampone
            \item \uttr{The Bvryzax River does not run through Europe.}
    ...
    \subsection{\subonethree}
      \begin{frame}[t]{\subonethree}
        \begin{alertblock}{Presupposition trigger}
          \input{\defs/part3/def_presupposition_trigger.tex}
        \end{alertblock}
        \only<-4>{
    ...
    \subsection{\subonefour}
      \begin{frame}{\subonefour}
        ...
        \begin{alertblock}<3->{Presupposition accommodation}
          \input{\defs/part3/def_presupposition_accommodation.tex}
        \end{alertblock}
      \end{frame}
