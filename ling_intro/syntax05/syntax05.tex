  ...
  \section{Constructing a grammar}
      ...
      \begin{frame}[t]{\subonetwo}
        ...
        \only<7-8>{
          \begin{block}{Lexical expressions}
            \uncover<8->{
              \input{\defs/part3/def_lexical_expression.tex}
              \begin{itemize}
    ...
    \subsection{\subonethree}
      \begin{frame}[t]{\subonethree}
        \begin{alertblock}{Phrase structure rewrite rules \parencite{chomsky_syntactic_2002}}
          \input{\defs/part3/def_phrase_structure_rewrite_rule.tex}
        \end{alertblock}
        \only<2-4>{
          ...
          \only<4>{
            ...
            \begin{alertblock}{Immediate constituents}
              \input{\defs/part3/def_immediate_constituents.tex}
            \end{alertblock}
          }
        }
      \end{frame}
      ...
      \begin{frame}{\subonethree}
        \begin{block}{}
          ...
          \begin{itemize}
            \item \input{\defs/part3/def_phrase_structure_tree.tex}
          \end{itemize}
        \end{block}
        \begin{forest}
          [S
    ...
    \subsection{\subonefour}
      ...
      \begin{frame}{\subonefour}
        \begin{alertblock}{Ambiguity}
          \input{\defs/part3/def_ambiguity.tex}
        \end{alertblock}
      ...
      \begin{frame}[t]{\subonefour}
        \begin{alertblock}{Lexical ambiguity}
          \input{\defs/part3/def_lexical_ambiguity.tex}
        \end{alertblock}
        \only<2>{
          \begin{block}{}
      ...
      \begin{frame}[t]{\subonefour}
        \begin{alertblock}{Structural ambiguity}
          \input{\defs/part3/def_structural_ambiguity.tex}
          \begin{itemize}
    ...
    \subsection{\subonesix}
      \begin{frame}{\subonesix}
        \begin{block}{}
          \input{../shared/syntax_resources.tex}
        \end{block}
