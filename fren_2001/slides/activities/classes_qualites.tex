\begin{frame}{Ils ont quelles qualités?}
  \begin{columns}
    ...
    \column{0.5\textwidth}
      \uncover<2>{
        En groupes de 4, discutez de ce que font les membres de chaque classe sociale aux États-Unis au-dessous.
        Posez des questions au groupe, par exemple:
        \begin{itemize}
          \item[] \textbf{Modèle:}
          \item \emph{Qu'est que les ouvriers font?}
