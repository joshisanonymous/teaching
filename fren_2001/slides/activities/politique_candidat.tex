\begin{frame}[t]{Un.e candidat.e idéal.e}
  ...
  \only<2>{
    \vspace{1cm}
    Maintenant, discutez de votre candidat.e idéal.e avec un.e partenaire.
    Est-ce que vous votez pour des candidats similaires ou différentes? Pourquoi?
    \emph{Après finir}, discutez de votre candidat.e avec encore une autre personne de la même façon, puis avec une autre personne, etc.
  }
\end{frame}