\begin{frame}{La défense d'un président}
  ...
  \begin{enumerate}
    ...
    \item pour expliquer ce qu'il \underline{\uncover<3->{souhaitait}} (souhaiter) accomplir durant la prochaine année de son mandat.
    ...
    \item qui \underline{\uncover<11->{constituait}} (constituer) à présent une préoccupation majeure des électeurs.
