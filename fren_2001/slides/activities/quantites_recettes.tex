\begin{frame}{Cuisinons}
  ...
  \begin{columns}
    ...
    \column{0.3\textwidth}
      \begin{itemize}
        \item réchauffer \gloss{to heat}
        \item verser \gloss{to pour}
        \item brasser \gloss{to stir}
        \item couper \gloss{to cut}
        \item mélanger \gloss{to mix}
        \item une cuisinière \gloss{stove}
        \item un four \gloss{oven}
        \item une poêle \gloss{pan}
        \item une casserole \gloss{pot}
      \end{itemize}
    \column{0.7\textwidth}
      \begin{description}
        \item[] \textbf{Modèle:}
