\begin{frame}[b]{Des personnes importantes}
  \only<1>{
    Pensez aux hommes et aux femmes qui jouent ou qui ont joué un rôle important dans vos vies.
    Qui sont-ils?
    ...
    Écrivez un paragraphe qui répond à ces questions.
  }
  \only<2->{
    Maintenant, en groupes de 3, discutez de la personne dont vous avez écrit.
    \vspace{1cm}
  }
  \begin{columns}
    \column{0.3\textwidth}
