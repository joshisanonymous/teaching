\begin{frame}{Un endroit fréquenté}
  \only<1>{
    Quels sont les endroits à Athens que tu fréquentes?
    Est-ce qu'il y a des bâtiments? Des magasins? Un quartier? Des cafés ou des bars?
    Cherche un(e) autre étudiant(e) qui fréquente un endroit que tu fréquentes.
    \begin{description}
      \item[] \textbf{Modèle:}
  ...
  \only<3>{
    \alert{Enfin}, écris un paragraphe qui décrit cet endroit.
    Utilise beaucoup d'adjectifs pour l'endroit, les gens et les choses à cet endroit.
  }
\end{frame}