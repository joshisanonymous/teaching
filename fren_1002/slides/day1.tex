    ...
    \end{center}
      \only<1>{
        \begin{itemize}
          ...
          \item[E1:] Je suis de \underline{\hspace{2cm}}. Et toi?
          \item[E2:] Moi, je suis de \underline{\hspace{2cm}}.
          \item[E1:] J'étudie \underline{\hspace{2cm}}. Et toi?
          \item[E2:] Moi, j'étudie \underline{\hspace{2cm}}.
          \item[E1:] Enchanté/e!
          \item[E2:] Enchanté/e!
        \end{itemize}
      }
      \only<2->{
        \begin{itemize}
          \item Voici mon voisin/ma voisine.
          \item Il/Elle s'appelle \underline{\hspace{2cm}}.
          \item Il/Elle est de \underline{\hspace{2cm}}, et il/elle étudie \underline{\hspace{2cm}}.
        \end{itemize}
        \begin{center}
          {\small\textit{Pronom non-binaire $\to$ iel (sg.) \gloss{they}}}
        \end{center}
      }
  \end{frame}
