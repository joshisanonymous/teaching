...
\begin{document}
  ...
  \begin{frame}{Les conjugaisons}
    ...
    \begin{enumerate}
      \item On \underline{\uncover<2->{appelle}} le chat Minou.
      \item Ils \underline{\uncover<3->{jettent}} la carafe par la fenêtre.
      \item Vous \underline{\uncover<4->{achetez}} une assiette de bananes grillées.
      \item Tu \underline{\uncover<5->{lèves}} le bol de soupe.
      \item J'\underline{\uncover<6->{achète}} un repas copieux.
    \end{enumerate}
  \end{frame}
