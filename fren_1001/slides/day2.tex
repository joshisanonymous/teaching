...
\begin{document}
  ...
  \begin{frame}{Le premier verbe \gloss{The first verb}}
    \begin{enumerate}
      \item Elle \underline{\uncover<2->{est}} une amie.
      \item Tu \underline{\uncover<3->{es}} occupé/e.
      \item Nous \underline{\uncover<4->{sommes}} malades.
      \item Ils \underline{\uncover<5->{sont}} en forme.
      \item Je \underline{\uncover<6->{suis}} stressé/e.
      \item Elles \underline{\uncover<7->{sont}} de Géorgie.
    \end{enumerate}
  \end{frame}
